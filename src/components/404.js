		...
		<div className="min-h-screen flex items-center justify-center w-10/12 m-auto">
			{
				<DynamicMeta
					...
					description={
						"The page " +
						currentUrl +
						" could not be found in our website. Please try again with a different url"
					}
				/>
			}
			<div className="hidden md:flex md:w-1/2 p-8">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
					<g
						id="freepik--background-complete--inject-63"
			...
			<div className="w-full md:w-1/2 p-4 md:p-8">
				<h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-4">
					<a href="http://www.ovff.org/pegasus/songs/404-not-found.html">
						Not Again!!!
					</a>
				</h1>
				<div className="text-lg md:text-xl text-gray-600 mb-8">
					<p>
						Sorry you dropped out of our store, say hello to the
						stars for us.
					</p>
					<p>
						Our team of highly trained gekkos are shopping for the
						best ways to get you back to our store!
					</p>
				</div>
				<a href="/">
